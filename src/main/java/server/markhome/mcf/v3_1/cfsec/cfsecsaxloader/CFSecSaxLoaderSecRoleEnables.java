...
/*
 *	CFSecSaxLoaderSecRoleEnablesParse XML SAX Element Handler implementation
 *	for SecRoleEnables.
 */
public class CFSecSaxLoaderSecRoleEnables
	extends CFLibXmlCoreElementHandler
{
	public CFSecSaxLoaderSecRoleEnables( CFSecSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		ICFSecSecRoleEnablesObj origBuff = null;
		ICFSecSecRoleEnablesEditObj editBuff = null;
		// Common XML Attributes
		String attrId = null;
		// SecRoleEnables Attributes
		String attrEnableGroup = null;
		// SecRoleEnables References
		ICFSecSecRoleObj refRole = null;
		...
		try {
			...
			origBuff = (ICFSecSecRoleEnablesObj)schemaObj.getSecRoleEnablesTableObj().newInstance();
			editBuff = (ICFSecSecRoleEnablesEditObj)origBuff.beginEdit();
			...
			else if( scopeObj instanceof ICFSecSecRoleObj ) {
				refRole = (ICFSecSecRoleObj) scopeObj;
			...
			CFSecSaxLoader.LoaderBehaviourEnum loaderBehaviour = saxLoader.getSecRoleEnablesLoaderBehaviour();
			ICFSecSecRoleEnablesEditObj editSecRoleEnables = null;
			ICFSecSecRoleEnablesObj origSecRoleEnables = (ICFSecSecRoleEnablesObj)schemaObj.getSecRoleEnablesTableObj().readSecRoleEnablesByIdIdx( refRole.getRequiredSecRoleId(),
			...
			if( origSecRoleEnables == null ) {
				...
				switch( loaderBehaviour ) {
					case Insert:
						break;
					case Update:
						editSecRoleEnables = (ICFSecSecRoleEnablesEditObj)origSecRoleEnables.beginEdit();
			...
			if( editSecRoleEnables != null ) {
				if( origSecRoleEnables != null ) {
					...
					origSecRoleEnables = (ICFSecSecRoleEnablesObj)editSecRoleEnables.create();
				}
				editSecRoleEnables = null;
			}
