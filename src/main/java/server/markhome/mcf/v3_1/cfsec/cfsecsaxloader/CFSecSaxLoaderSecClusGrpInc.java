	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFSecSecClusGrpIncObj origSecClusGrpInc = (ICFSecSecClusGrpIncObj)schemaObj.getSecClusGrpIncTableObj().readSecClusGrpIncByIdIdx( refGroup.getRequiredSecClusGrpId(),
