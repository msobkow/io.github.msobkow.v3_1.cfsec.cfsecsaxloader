	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFSecSecTentGrpMembObj origSecTentGrpMemb = (ICFSecSecTentGrpMembObj)schemaObj.getSecTentGrpMembTableObj().readSecTentGrpMembByIdIdx( refGroup.getRequiredSecTentGrpId(),
